...
// @CrossOrigin(origins = "http://localhost:4200", maxAge = 3600)  jdc todo in comment correct? see proxy.congig.json and http://www.devglan.com/spring-boot/spring-boot-angular-example
@Controller
